package com.fanavard.alisherafat.khatereha.app.custom;
...
/**
 * Custom view to show Audio items for each memory
 */
public class AudioPlayer extends LinearLayout {
    ...
    private void iniiMedaPlayer() {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mp) {
                ...
                txtTime.setText(totalTime);
                seekbar.setProgress(0);
                fabToggle.setImageResource(R.drawable.ic_action_playback_play);
            }
        });
    }
    ...
    public void togglePlayPause() {
        ...
        if (mediaPlayer.isPlaying()) {
            ...
            mediaPlayer.start();
            isPlaying = true;
            fabToggle.setImageResource(R.drawable.ic_action_playback_pause);
            handelPlayingMode();
        }
    }
