...
/**
 * Helper class to manage preferences in local storage<br/>
 * Singleton pattern is used in this class to retrieve one Object over app
 */
public class PreferenceHelper {
    ...
    private static WeakReference<PreferenceHelper> instance;
